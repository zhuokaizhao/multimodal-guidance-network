...
__all__ = ["MobileOneEncoder", "mobileone_encoder", "reparameterize_model"]
...
class MobileOneEncoder(nn.Module):
    ...
    def __init__(
        ...
        :param num_conv_branches: Number of linear conv branches.
        """
        super(MobileOneEncoder, self).__init__()
...
def mobileone_encoder(
    num_classes: int = 1000, inference_mode: bool = False, variant: str = "s4"
) -> nn.Module:
    """Get MobileOne model.
